...
Sphere::Render(float radius, glm::mat4 transform)
{
  ...
  auto local_model = glm::scale(transform, glm::vec3(radius_));
...
void
Sphere::Update(glm::mat4 transform)
{
  auto local_model = glm::scale(transform, glm::vec3(radius_));
  base_technique_.Uniform(0, "local_model", local_model);
}
...
Sphere::Init()
{
  ...
  const char* fragment_shader_source =
      wire_ ? default_fragment_shader_source : texture_fragment_shader_source;
